...
the [snapcraft.yaml](https://github.com/snapcrafters/github-desktop/blob/master/snap/snapcraft.yaml)
upstream so GitHub Desktop can authoritatively publish future releases.
